...
public class HomeUpcomingAdapter extends RecyclerView.Adapter<HomeUpcomingAdapter.HorizontalViewHolder> {
    ...
    public HomeUpcomingAdapter(List<Movie> mdata, RcvInterfce rcvInterfce) {
